...
<div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px 
    ...
    <form action="../process/updateAdminProcess.php" method="post" enctype="multipart/form-data">
        <div class="card" style="margin-left: 20px; margin-top:30px;">
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="email" name="email" readonly value="<?php echo $fetch['email']; ?>">
            </div>
