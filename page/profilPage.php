...
<div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px 
   ...
   <div class="card mb-3" style="max-width: 580px; margin-top: 50px; margin-left:400px;">
      <div class="row g-12">
         <div class="col-md-4" >
            <div class="profil" >
               <?php
         ...
         <div class="col-md-8" style="margin-left:30px;">
            ...
            <div class="d-grid gap-2">
               <a href="../page/updatePage.php" type="submit" class="btn btn-primary" name="Update" style="margin-left:120px;">Update</a>
            </div>
            </div>
         </div>
      </div>
